      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            ML apps that provide value
          </h2>
          <p className="md:text-md">
            Whether deployed in the hospital or on the web, my apps see what matters in data
          </p>
        </div>
              ...
              <div className="z-10">
                ...
                <div className="lg:hidden">
                  <p className="mt-5 text-text-alternative md:mt-6">
                    Tracks traffic in realtime, keeping track of busses, truck, cars and bikes seperately. Even works from a simple webcam
                  </p>
          ...
          >
            ...
            <div className="group relative flex h-full min-h-[70vh] flex-col justify-end p-6 md:p-8">
              ...
              <div className="z-10">
                ...
                <div className="lg:hidden">
                  <p className="mt-5 text-text-alternative md:mt-6">
                    Transcribes audio to text with timestamps in 72 different languages. It is open sourced too
                  </p>
                  <div className="mt-6 md:mt-8">
                    <Button
                      variant="primary"
